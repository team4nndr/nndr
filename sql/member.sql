...
CREATE TABLE "MEMBER" (
	...
	"MEMBER_CODE"		CHAR(2)		DEFAULT 'N'	NOT NULL,
	"ENROLL_DATE"		DATE		DEFAULT SYSDATE	NOT NULL,
	"DISABLE_DATE"		DATE						NULL,
	"DELETE_DATE"		DATE						NULL,
	"SET_FRIEND_REQ"	CHAR(1)		DEFAULT 'Y'		NOT NULL,
	"SET_FEED_AUTH"		CHAR(1)		DEFAULT 'A'		NOT NULL,
...
COMMENT ON COLUMN "MEMBER"."SET_AL_FRIEND_REQ" IS '친구요청알림(A:모든살람, F:친구만, M:나만)';
...
ALTER TABLE "MEMBER" ADD CONSTRAINT "CHK_SET_FEED_AUTH" CHECK(SET_FEED_AUTH IN('A', 'F', 'M'));
...
UPDATE "MEMBER" SET MEMBER_PW='$2a$10$QXYbXcWMFiywPBVtwyYYEOlb5OQP6EPeZzZI2oZcjT54hF5uENhSO' WHERE MEMBER_EMAIL!='ADMIN' OR MEMBER_NO=314;
